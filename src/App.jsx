  ...
  return (
    <div className={`w-full min-h-screen flex items-center justify-center overflow-x-hidden`}>
      ...
      >
        ...
        <div className="fixed inset-0 pointer-events-none z-[10] opacity-[0.07] mix-blend-overlay user-select-none"><svg className="w-full h-full"><filter id="globalNoise"><feTurbulence type="fractalNoise" baseFrequency="0.85" numOctaves="3" stitchTiles="stitch" /></filter><rect width="100%" height="100%" filter="url(#globalNoise)" /></svg></div>
